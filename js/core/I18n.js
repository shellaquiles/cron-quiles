...
const TRANSLATIONS = {
    es: {
        ...
        'section.communitiesSub': 'Conectamos más de 60 grupos de usuarios, capítulos locales y colectivos tecnológicos en todo México (CDMX, Guadalajara, Puebla, Monterrey y online).',
        'section.ics': 'Calendario ICS',
        'section.json': 'Datos JSON',
        'section.howto': 'Cómo usar',
        'badge.recommended': 'Recomendado',
        'badge.hero': 'EVENTOS TECH MÉXICO',
        ...
        'cal.next': 'Siguiente ▶',
        'cal.today': 'Hoy',
        'cal.fullMonth': 'MES COMPLETO',
        'cal.viewAllMonth': 'VER TODO EL MES',
        ...
        'hero.title': 'El calendario unificado del ecosistema tecnológico en México.',
        'hero.desc': 'Monitoreamos y sincronizamos los eventos de las principales comunidades técnicas del país: desde Ciudad de México, Guadalajara y Monterrey hasta Puebla y modalidades remotas. Todo en un solo feed abierto y sin fines de lucro.',
        'landing.explorarEventos': 'Explorar eventos ↗',
        'landing.proximosEventos': 'PRÓXIMOS EVENTOS',
        'landing.verCalendarioCompleto': 'VER CALENDARIO COMPLETO ↗',
        'landing.verTodos': 'VER TODOS',
        'landing.verEventos': 'Ver eventos ↗',
        'landing.anadirCalendario': '+ Añadir a mi calendario',
        'landing.organizeTitle': '¿Organizas un evento de tecnología en México?',
        'landing.organizeDesc': 'Comparte tu evento con miles de desarrolladores, ingenieros y entusiastas tech en todo el país. Ya sea presencial o en línea, añade la fecha de tu meetup, hackathon o workshop para sincronizarlo automáticamente con la red comunitaria.',
        'landing.proposeBtn': 'Proponer un Evento ↗',
    ...
    en: {
        ...
        'section.communitiesSub': 'Connecting over 60 user groups, local chapters, and tech collectives across Mexico (CDMX, Guadalajara, Puebla, Monterrey, and online).',
        'section.ics': 'ICS Calendar',
        'section.json': 'JSON Data',
        'section.howto': 'How to use',
        'badge.recommended': 'Recommended',
        'badge.hero': 'MEXICO TECH EVENTS',
        ...
        'btn.copied': '✓ Copied!',
        'tip.label': 'Tip:',
        'tip.content': 'To subscribe automatically, use the WebCal URL or import the ICS file in your calendar app. Events will update automatically.',
        ...
        'cal.next': 'Next ▶',
        'cal.today': 'Today',
        'cal.fullMonth': 'FULL MONTH',
        'cal.viewAllMonth': 'VIEW FULL MONTH',
        ...
        'hero.title': 'The unified calendar for the Mexican tech ecosystem.',
        'hero.desc': 'We track and synchronize events from leading technical communities across Mexico: from Mexico City, Guadalajara, and Monterrey to Puebla and remote formats. All in an open, non-profit feed.',
        'landing.explorarEventos': 'Explore events ↗',
        'landing.proximosEventos': 'UPCOMING EVENTS',
        'landing.verCalendarioCompleto': 'VIEW FULL CALENDAR ↗',
        'landing.verTodos': 'VIEW ALL',
        'landing.verEventos': 'View events ↗',
        'landing.anadirCalendario': '+ Add to my calendar',
        'landing.organizeTitle': 'Organizing a tech event in Mexico?',
        'landing.organizeDesc': 'Share your event with thousands of developers, engineers, and tech enthusiasts nationwide. In-person or virtual, submit your meetup, hackathon, or workshop date to sync automatically with the network.',
        'landing.proposeBtn': 'Submit an Event ↗',
