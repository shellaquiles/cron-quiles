...
const TRANSLATIONS = {
    es: {
        ...
        'hero.title': 'El calendario unificado del ecosistema tech en México.',
        'hero.desc': 'Agregamos meetups, talleres y conferencias de múltiples plataformas (Meetup, Luma, Eventbrite) en una sola interfaz técnica, abierta y accesible.',
    ...
    en: {
        ...
        'hero.desc': 'We aggregate meetups, workshops, and conferences across multiple platforms (Meetup, Luma, Eventbrite) into a single, open, and accessible interface.',
